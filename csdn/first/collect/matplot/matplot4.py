# -*- coding: utf-8 -*-
"""
Created on Tue Aug  4 01:01:49 2020
...
import struct
# =============================================================================
# import pandas as pd /dev/ttyUSB0
# =============================================================================
...
class serialPlot:
    def __init__(self, serialPort = 'D:/d/tmp', serialBaud = 38400, plotLength = 100, dataNumBytes = 2):
