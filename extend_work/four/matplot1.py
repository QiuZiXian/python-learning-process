...
ax.set_xlabel('wavelength $\lambda$($\mu$m)', color='b', fontdict=font1)
ax.set_ylabel('partical size($\mu$m)', color='g', fontdict=font1)

# ax.set_zlabel('Exitinction effciency factor $}txe{_Q$'[::-1], color='r', fontdict=font1)
ax.set_zlabel('Exitinction effciency factor $Q{_ext}$', color='r', fontdict=font1)
